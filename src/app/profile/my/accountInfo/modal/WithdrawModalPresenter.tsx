...
interface IWithdrawModalPresenterProps extends IModalContainerCommonProps {
	onClick: () => void;
}

const WithdrawModalPresenter = ({ open, onClose, onClick }: IWithdrawModalPresenterProps): JSX.Element => {
	return (
		<SimpleModal
			open={open}
			onClose={onClose}
...
export default WithdrawModalPresenter;
