    ...
    return(
        <div>
            <div className="portal">
                <form>
                    <input type="text" className="signportal-id" value="ID" placeholder="포탈 아이디"/>
                    <input type="password" className="signportal-pd" value="password" placeholder="비밀번호 (특수문자를 포함한 8자 이상)"/>
                </form>
