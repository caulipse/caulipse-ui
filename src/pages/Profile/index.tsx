import { AchievementPage, BookmarkPage, MyPage, SettingPage, StudyPage, StudyRecruitPage } from "@src/app/profile";
...
const ProfilePage = (): JSX.Element => (
  <Switch>
    ...
    <Route exact path='/profile/achievement' component={AchievementPage} />
